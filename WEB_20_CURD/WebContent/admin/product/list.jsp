...
<script type="text/javascript">
	...
	$(function(){
		//是否热门回显
		$("#isHot option[value='${condotion.isHot}']").prop("selected",true);
		//商品分类回显
		$("#cid option[value='${condotion.cid}']").prop("selected",true);
	});
...
<body>
	...
	<form id="Form1" name="Form1"
		...
		method="post">
		&nbsp;&nbsp;&nbsp;&nbsp; 
		商品名称：<input type="text" name="pname" value="${condotion.pname }">&nbsp;&nbsp;&nbsp;

		是否热销：<select name="isHot" id="isHot">
